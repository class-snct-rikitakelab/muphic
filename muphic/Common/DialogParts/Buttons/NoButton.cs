...
namespace Muphic.Common.DialogParts.Buttons
{
	...
	public class NoButton : Button
	{
		...
		public NoButton(Dialog dialog, Point location)
		{
			...
			this.SetLabelTexture(this.ToString(), Tools.CommonTools.AddPoints(this.Parent.Location, location), "IMAGE_DIALOG_BUTTON_NO");
		}


		/// <summary>
		/// "いいえ"ボタンがクリックされた時に呼ばれる。
		/// </summary>
