...
namespace Muphic.Common.DialogParts.Buttons
{
	...
	public class BackButton : Button
	{
		...
		public BackButton(Dialog dialog, Point location)
		{
			this.Parent = dialog;
			...
			this.SetLabelTexture(this.ToString(), Tools.CommonTools.AddPoints(this.Parent.Location, location), "IMAGE_DIALOG_BUTTON_BACK");
		}
