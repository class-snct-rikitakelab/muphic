...
{
	/// <summary>
	/// GoodsButton ÇÃäTóvÇÃê‡ñæÇ≈Ç∑ÅB
	/// </summary>
	public class GoodsButton : Base
	{
		public MakeStoryScreen parent;

		public GoodsButton(MakeStoryScreen mss)
		{
			parent = mss;
		}
		...
		{
			base.Click (p);
			if(parent.ButtonsMode == muphic.MakeStory.ButtonsMode.Goods)
			{
			...
			else
			{
				if(parent.isClear)
					parent.cb.Reset();
				parent.ButtonsMode = muphic.MakeStory.ButtonsMode.Goods;
				this.State = 1;
