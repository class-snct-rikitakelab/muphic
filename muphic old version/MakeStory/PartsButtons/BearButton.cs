...
{
	/// <summary>
	/// BearButton ‚ÌŠT—v‚Ìà–¾‚Å‚·B
	/// </summary>
	public class BearButton : Base
	{
		public MakeStoryScreen parent;

		public BearButton(MakeStoryScreen mss)
		{
			parent = mss;
		}
		...
		public override void Click(System.Drawing.Point p)
		{
			...
			if(parent.ButtonsMode == muphic.MakeStory.ButtonsMode.Bear)
			{
			...
			else
			{
				if(parent.isClear)
					parent.cb.Reset();
				parent.ButtonsMode = muphic.MakeStory.ButtonsMode.Bear;
				this.State = 1;
				parent.man.State = 0;
				parent.lady.State = 0;
				parent.girl.State = 0;
