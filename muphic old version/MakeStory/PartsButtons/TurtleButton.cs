...
{
	/// <summary>
	/// TurtleButton ‚ÌŠT—v‚Ìà–¾‚Å‚·B
	/// </summary>
	public class TurtleButton : Base
	{
		public MakeStoryScreen parent;

		public TurtleButton(MakeStoryScreen mss)
		{
			parent = mss;
		}
		...
		{
			base.Click (p);
			if(parent.ButtonsMode == muphic.MakeStory.ButtonsMode.Turtle)
			{
			...
			else
			{
				if(parent.isClear)
					parent.cb.Reset();
				parent.ButtonsMode = muphic.MakeStory.ButtonsMode.Turtle;
				this.State = 1;
