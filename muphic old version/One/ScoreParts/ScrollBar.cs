...
namespace muphic.One.ScoreParts
{
	...
	public class ScrollBar : Screen
	{
		...
		bool isDrag = false;										//バーが現在ドラッグ状態にあるかどうか(ドラッグとクリックを識別するために必要)
		...
		{
			base.DragBegin (begin);System.Diagnostics.Debug.WriteLine("as;dlfkjas;klfjasdkl;j");
