...
//	/// </summary>
//	public class Question01Button : Base
//	{
//		public SelectButtons parent;
//		public Question01Button(SelectButtons select)
//		{
//			parent = select;
//		}
//
...
//		{
//			base.Click (p);
//			if(parent.NowClick != muphic.Link.Dialog.Select.SelectButtonsClickMode.Ques01)
////			{
...
////			else															
//			{
//				parent.NowClick = muphic.Link.Dialog.Select.SelectButtonsClickMode.Ques01;
