...
//	/// </summary>
//	public class Question06Button : Base
//	{
//		public SelectButtons parent;
//		public Question06Button(SelectButtons select)
//		{
//			parent = select;
//		}
//
...
//		{
//			base.Click (p);
////			if(parent.NowClick != muphic.Link.Dialog.Select.SelectButtonsClickMode.Ques06)
////			{
...
////			else															
//			{
//				parent.NowClick = muphic.Link.Dialog.Select.SelectButtonsClickMode.Ques06;
