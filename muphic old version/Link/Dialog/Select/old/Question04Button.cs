...
//	/// </summary>
//	public class Question04Button : Base
//	{
//		public SelectButtons parent;
//		public Question04Button(SelectButtons select)
//		{
//			parent = select;
//		}
//
...
//		{
//			base.Click (p);
//			if(parent.NowClick != muphic.Link.Dialog.Select.SelectButtonsClickMode.Ques04)
////			{
...
////			else															
//			{
//				parent.NowClick = muphic.Link.Dialog.Select.SelectButtonsClickMode.Ques04;
