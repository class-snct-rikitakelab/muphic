...
namespace muphic.Story
{
	...
	public class VoiceRegistDialog : Screen
	{
		...
		public muphic.Story.VoiceDialog.BackButton back;
		...
		public bool IsRecording
		{
			...
			set
			{
				...
				else
				{
					...
					{
						parent.StoryScreenMode = muphic.StoryScreenMode.VoiceRegistOneMoreDialog;
					}
				}
			}
		}
		public VoiceRegistDialog(StoryScreen story)
		{
			parent = story;
...
//			DrawManager.BeginRegist();
			...
			back = new muphic.Story.VoiceDialog.BackButton(this);
